...
String username=(String)session.getAttribute("user2");
System.out.println("user name1="+username);
	...
	ResultSet rs=s.executeQuery("select count(shipid) from shipingadd");
         ...
         if(ss==0)
		{
			...
			System.out.println("iddddddddddd="+username);
		...
		else
		{
			...
			stmt.addBatch("insert into address(emailid,address1,address2,landmark,city,pincode,state,username,orderid) values('"+emailid+ "','"+address+"','"+ship_address+"','"+landmark+"','"+city+"','"+areacode+"','"+state+"','"+username+"','"+orderid+"')");
...
HttpSession session=request.getSession(false);
		...
		try {
			...
			stmt1.addBatch("insert into address(emailid,address1,address2,landmark,city,pincode,state,username,orderid) values('"+emailid+ "','"+address+"','"+ship_address+"','"+landmark+"','"+city+"','"+areacode+"','"+state+"','"+username+"','"+orderid+"')");
