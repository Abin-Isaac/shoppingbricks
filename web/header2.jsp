...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-show-password/1.0.3/bootstrap-show-password.min.js"></script></head>
<body>
     <%!
  ...
  <div class="container-fluid">
    ...
    <div class="col-sm-5" id="myNavbar">
        ...
        <div class="col-sm-4">
         ...
         <ul class="nav navbar-nav navbar-right col-sm-6 ">
             <%
                  ...
                  String   label=(String)session.getAttribute("user2");
                     if(label==null)
                     {
                     %>
      ...
      <li class="btn btn-success center-block" style="background-color: #DC143C" data-toggle="modal" data-target="#myModal" onClick="$('#loginbox').show(); $('#signupbox').hide();$('#forpass').hide()"><span style=" font-size: 1.7em"><b>Login</b></span></li>
             ...
             <li class="pull-left"><a href="viewCart.jsp;"><span style="color: #ffffff" class="fa fa-shopping-cart">(0)</span></a></li>
        ...
        <div id="signupbox" style="display:none; margin-top:50px">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <form id="signupform" class="form-horizontal" role="form" method="post" action="viewCart.jsp">
