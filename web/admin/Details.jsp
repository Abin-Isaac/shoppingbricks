<%-- 
    Document   : Details
    Created on : 9 Apr, 2018, 1:58:40 PM
    Author     : shravan
--%>
	...
	Connection connection=ConnectionProvider.getCon();
     ...
     <%
       // String id=request.getParameter("pcatid");
        int s=Integer.parseInt(request.getParameter("var"));
        
        System.out.println("value2:"+s);
        %>
...
<header class="main_header bg-success">
		...
		<div class="row">
			<div class="col-md-6">
				<h1><i class="fa fa-User"></i>Details</h1>
			</div>
		</div>
...
<section id="category">
	<div class="container-fluid">
			...
			<div class="card-header thead-red">
						...
						<tbody>
                                                    <% 
                                                     PreparedStatement ps=connection.prepareStatement("select * from product where pid='"+s+"'");
