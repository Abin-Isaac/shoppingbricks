<%-- 
    Document   : test
    Created on : Mar 20, 2018, 3:06:40 AM
    Author     : hp
--%>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" method="post" role="form" action="register.jsp">
                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form" method="post" action="register.jsp">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="email" placeholder="Email Address" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
                                    </div>
                                </div>
