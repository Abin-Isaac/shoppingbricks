...
<div id="description">
    ...
    <div style=" display:block"><br><h3><span style=" color:white"> Availabilty:</span></h3>&nbsp;<span style=" color:red"><%=rs13.getInt("pquantity")%> in Stock</span></div>
            ...
            </div><p style=" color:white"><h2><%=rs13.getString("pmodel")%></h2>
       
        <p class="text-center"><a href="AddCart?pid=<%=rs13.getInt("pid")%>"><button type="submit" class="btn btn-success">Add To Cart &nbsp </button></a></p>
