			...
			<ul class="navbar-nav second_navbar list-inline ">
				<li class="nav-item dropdown ">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <img class="img-circle" src="../images/Abin.jpg"  style="width:10%; height:40px; margin-right:5%;"/>Welcome Abin
					</a>
			...
			<div class="modal-body">
					...
					<div class="form-group">
						<label for="file">Image upload</label>
                                                <input type="file" name="pimage" class="form-control-file" id="file" required="" placeholder="Browse">
